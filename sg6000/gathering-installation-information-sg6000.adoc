...
Debe conectar las dos controladoras de almacenamiento del dispositivo (tanto las controladoras serie E2800 como las controladoras EF570) a la red de gestión que se usará para SANtricity System Manager. Los controladores se encuentran en cada dispositivo de la siguiente manera:
...
| Información necesaria | Su valor para la controladora A | Su valor para la controladora B. 
 ...
 a| 
Puerto del switch Ethernet se conectará al puerto de gestión 1 (etiquetado como P1 en la controladora E2800A y 0a en la controladora E2800B)
 a| 
 a| 
 ...
 a| 
Dirección MAC para el puerto de gestión 1 (impreso en una etiqueta cerca del puerto P1 en la controladora E2800A y 0a en la controladora E2800B)
 a| 
 a| 
...
xref:controllers-in-sg6000-appliances.adoc[Controladoras en dispositivos SG6000]

xref:reviewing-appliance-network-connections-sg6000.adoc[Revisar las conexiones de red del dispositivo (SG6000)]
