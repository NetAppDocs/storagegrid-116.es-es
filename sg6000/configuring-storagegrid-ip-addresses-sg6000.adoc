...
Si desea cambiar la configuración de vínculos, consulte xref:changing-link-configuration-of-sg6000-cn-controller.adoc[Instrucciones para cambiar la configuración de enlace del controlador SG6000-CN].
