...
.. xref:shutting-down-sg6000-cn-controller.adoc[Apague el aparato].
...
. xref:connecting-power-cords-and-applying-power-sg6000.adoc[Conecte los cables de alimentación a las unidades sustituidas y aplique alimentación].
