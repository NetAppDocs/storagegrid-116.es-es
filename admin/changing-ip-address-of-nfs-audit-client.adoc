...
* xref:adding-nfs-audit-client-to-audit-share.adoc[Agregar un cliente de auditoría NFS a un recurso compartido de auditoría]
* xref:removing-nfs-audit-client-from-audit-share.adoc[Eliminar un cliente de auditoría NFS del recurso compartido de auditoría]
