...
. Cuando haya terminado, vuelva a StorageGRID y pruebe todos los fideicomisos de las partes que dependan para confirmar que están configurados correctamente. Consulte xref:using-sandbox-mode.adoc[Utilice el modo Sandbox] si desea obtener instrucciones.
...
. Repita estos pasos para configurar una confianza de parte que confía para todos los nodos de administración del sistema StorageGRID.
. Cuando haya terminado, vuelva a StorageGRID y pruebe todos los fideicomisos de las partes que dependan para confirmar que están configurados correctamente. Consulte xref:using-sandbox-mode.adoc[Utilizar el modo de recinto de seguridad] si desea obtener instrucciones.
