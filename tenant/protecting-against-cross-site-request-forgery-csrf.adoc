...
Para configurar la protección CSRF, utilice xref:../admin/using-grid-management-api.adoc[API de gestión de grid] o. xref:../tenant/understanding-tenant-management-api.adoc[API de gestión de inquilinos].
