...
* Debe colocar la controladora E5700SG en xref:placing-appliance-into-maintenance-mode.adoc[modo de mantenimiento], Que interrumpe la conexión a la controladora E2800.
+
