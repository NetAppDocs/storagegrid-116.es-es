...
---
= Establezca la configuración de IP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
xref:changing-link-configuration-of-e5700sg-controller.adoc[Cambie la configuración del enlace de la controladora E5700SG]
