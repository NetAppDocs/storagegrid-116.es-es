...
NOTE: Si va a poner en marcha el dispositivo Storage Node como destino de clonado de nodos, detenga el proceso de puesta en marcha aquí y continúe con el procedimiento de clonado de nodos en recuperación y mantenimiento.
