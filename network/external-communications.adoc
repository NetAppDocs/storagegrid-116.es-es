...
NOTE: En esta lista no se incluyen los puertos que se pueden configurar como xref:../admin/configuring-load-balancer-endpoints.adoc[puntos finales del equilibrador de carga].
