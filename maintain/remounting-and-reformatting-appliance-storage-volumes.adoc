...
. Vuelva a la página instalación del monitor del instalador de dispositivos StorageGRID introduciendo `https://Controller_IP:8443`, Utilizando la dirección IP del controlador de computación.
+
