...
NOTE: Puede usar varias puertas de enlace y grupos de alta disponibilidad para proporcionar conmutación por error automática durante el proceso de revisión. Consulte las instrucciones para xref:../admin/configure-high-availability-group.adoc[configuración de grupos de alta disponibilidad].
