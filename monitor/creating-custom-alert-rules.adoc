...
* Usted entiende la https://["Sintaxis de las consultas Prometheus"^]
* Opcionalmente, ha visto el vídeo: https://["Vídeo: Uso de métricas para crear alertas personalizadas"^]
+
