...
NOTE: Para la actualización a StorageGRID 11.6, puede utilizar opcionalmente una secuencia de comandos para actualizar y aplicar una revisión al mismo tiempo. Consulte https://["Base de conocimientos de NetApp: Cómo ejecutar scripts combinados de actualizaciones importantes y revisiones para StorageGRID"^].
