...
summary: Al instalar y configurar el dispositivo StorageGRID, debe tomar decisiones y recopilar información acerca de los puertos del switch Ethernet, las direcciones IP y los modos de enlace de puerto y red. Registre la información necesaria de cada red que conecte al dispositivo. Estos valores son necesarios para instalar y configurar el hardware. 
---
...
[role="lead"]
Al instalar y configurar el dispositivo StorageGRID, debe tomar decisiones y recopilar información acerca de los puertos del switch Ethernet, las direcciones IP y los modos de enlace de puerto y red. Registre la información necesaria de cada red que conecte al dispositivo. Estos valores son necesarios para instalar y configurar el hardware.
...
image::../media/sg100_rj_45_ports_circled.png[sg100 rj 45 puertos en círculo]
...
xref:sg100-and-sg1000-appliances-overview.adoc[Descripción general de los dispositivos SG100 y SG1000]

xref:cabling-appliance-sg100-and-sg1000.adoc[Aparatos de cable SG100 y SG1000]

xref:configuring-storagegrid-ip-addresses-sg100-and-sg1000.adoc[Configure las direcciones IP de StorageGRID]
