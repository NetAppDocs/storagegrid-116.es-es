...
NOTE: Este procedimiento es para usuarios avanzados con cierta experiencia usando interfaces de línea de comandos. Como alternativa, puede hacerlo xref:automating-appliance-configuration-using-storagegrid-appliance-installer.adoc[Use el instalador del dispositivo StorageGRID para automatizar la configuración].
